...
// File: translations/Turkish.reds
// Author: Spuddeh
// Description: The Turkish slot. EMPTY ON PURPOSE - every key falls through to English.
//
...
//              the mod manager hides this copy, so redscript compiles one NCZ_Turkish
...
public class NCZ_Turkish extends ModLocalizationPackage {
