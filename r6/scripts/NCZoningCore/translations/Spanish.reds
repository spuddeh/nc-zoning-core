...
// File: translations/Spanish.reds
// Author: Spuddeh
// Description: The Spanish slot. EMPTY ON PURPOSE - every key falls through to English.
//
...
//              the mod manager hides this copy, so redscript compiles one NCZ_Spanish
...
public class NCZ_Spanish extends ModLocalizationPackage {
