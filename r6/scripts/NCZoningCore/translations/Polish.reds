...
// File: translations/Polish.reds
// Author: Spuddeh
// Description: The Polish slot. EMPTY ON PURPOSE - every key falls through to English.
//
...
//              the mod manager hides this copy, so redscript compiles one NCZ_Polish
...
public class NCZ_Polish extends ModLocalizationPackage {
