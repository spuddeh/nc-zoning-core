...
// File: translations/Arabic.reds
// Author: Spuddeh
// Description: The Arabic slot. EMPTY ON PURPOSE - every key falls through to English.
//
...
//              the mod manager hides this copy, so redscript compiles one NCZ_Arabic
...
public class NCZ_Arabic extends ModLocalizationPackage {
