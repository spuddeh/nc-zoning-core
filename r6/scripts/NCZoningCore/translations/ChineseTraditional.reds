...
// Author: Spuddeh
// Description: The ChineseTraditional slot. EMPTY ON PURPOSE - every key falls through to English.
//
...
//              the mod manager hides this copy, so redscript compiles one NCZ_ChineseTraditional
...
public class NCZ_ChineseTraditional extends ModLocalizationPackage {
