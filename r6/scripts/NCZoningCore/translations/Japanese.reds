...
// File: translations/Japanese.reds
// Author: Spuddeh
// Description: The Japanese slot. EMPTY ON PURPOSE - every key falls through to English.
//
...
//              the mod manager hides this copy, so redscript compiles one NCZ_Japanese
...
public class NCZ_Japanese extends ModLocalizationPackage {
