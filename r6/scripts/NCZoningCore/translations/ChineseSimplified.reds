...
// Author: Spuddeh
// Description: The ChineseSimplified slot. Empty - every string shows in English until someone
...
public class NCZ_ChineseSimplified extends ModLocalizationPackage {
