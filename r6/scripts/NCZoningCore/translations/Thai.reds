...
// File: translations/Thai.reds
// Author: Spuddeh
// Description: The Thai slot. EMPTY ON PURPOSE - every key falls through to English.
//
...
//              the mod manager hides this copy, so redscript compiles one NCZ_Thai
...
public class NCZ_Thai extends ModLocalizationPackage {
