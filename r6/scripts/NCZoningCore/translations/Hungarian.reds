...
// File: translations/Hungarian.reds
// Author: Spuddeh
// Description: The Hungarian slot. EMPTY ON PURPOSE - every key falls through to English.
//
...
//              the mod manager hides this copy, so redscript compiles one NCZ_Hungarian
...
public class NCZ_Hungarian extends ModLocalizationPackage {
