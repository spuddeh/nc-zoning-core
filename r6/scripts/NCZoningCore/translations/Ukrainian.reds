...
// File: translations/Ukrainian.reds
// Author: Spuddeh
// Description: The Ukrainian slot. EMPTY ON PURPOSE - every key falls through to English.
//
...
//              the mod manager hides this copy, so redscript compiles one NCZ_Ukrainian
...
public class NCZ_Ukrainian extends ModLocalizationPackage {
