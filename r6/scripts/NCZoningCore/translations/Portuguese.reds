...
// Author: Spuddeh
// Description: The Portuguese slot. EMPTY ON PURPOSE - every key falls through to English.
//
...
//              the mod manager hides this copy, so redscript compiles one NCZ_Portuguese
