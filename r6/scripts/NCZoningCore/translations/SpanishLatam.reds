...
// File: translations/SpanishLatam.reds
// Author: Spuddeh
// Description: The SpanishLatam slot. EMPTY ON PURPOSE - every key falls through to English.
//
...
//              the mod manager hides this copy, so redscript compiles one NCZ_SpanishLatam
...
public class NCZ_SpanishLatam extends ModLocalizationPackage {
