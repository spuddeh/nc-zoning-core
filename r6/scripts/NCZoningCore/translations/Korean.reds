...
// File: translations/Korean.reds
// Author: Spuddeh
// Description: The Korean slot. EMPTY ON PURPOSE - every key falls through to English.
//
...
//              the mod manager hides this copy, so redscript compiles one NCZ_Korean
...
public class NCZ_Korean extends ModLocalizationPackage {
