...
- Fix: The North Oak casino is spelled the way the game spells it. It read "North Oaks Casino",
  directly under the "North Oak" row.
...
[list][*]New: District and subdistrict names show in your game's language, matching the world map.
[*]Fix: A location no longer reads as installed because another mod shipped the same file.
[*]Fix: The North Oak casino is spelled the way the game spells it.
[*]Changed: Housekeeping for a registry field the board no longer sends.
[/list]
[b][size=3]Version 1.1.0[/size][/b]
[spoiler][list][*]Changed: Cyber Engine Tweaks is no longer needed. Detection uses RedFunctions, now required.
